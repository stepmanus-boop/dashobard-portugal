-- v37.09 - Cache persistente seguro para Supabase Free + fallback sem tela vazia
...
comment on table public.step_tracking_cache is
  'Cache operacional STEP. v37.09: Supabase Free seguro, uma linha projects:BR:current, sem histórico, sem acesso público e com fallback do app quando vazio.';
