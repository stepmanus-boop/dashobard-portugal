-- v37.11: mantém a mesma tabela de cache único; a correção principal está no código para bloquear fallback empacotado antigo.
-- v37.11 - Cache persistente seguro para Supabase Free + fallback sem tela vazia
...
comment on table public.step_tracking_cache is
  'Cache operacional STEP. v37.11: Supabase Free seguro, uma linha projects:BR:current, sem histórico, sem acesso público e com fallback do app quando vazio.';
